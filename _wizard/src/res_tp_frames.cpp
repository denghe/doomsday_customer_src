...
xx::Task<> ResTpFrames::AsyncLoad(std::string picRoot) {
	{
		...
		this->char_1 = map["char_1"sv];
		this->_tex_char_1 = this->char_1->tex;
		this->_texid_char_1 = this->_tex_char_1->GetValue();
		this->char_2 = map["char_2"sv];
		this->_tex_char_2 = this->char_2->tex;
		this->_texid_char_2 = this->_tex_char_2->GetValue();
		...
		this->dark_bullet_1 = map["dark_bullet_1"sv];
		this->_tex_dark_bullet_1 = this->dark_bullet_1->tex;
		this->_texid_dark_bullet_1 = this->_tex_dark_bullet_1->GetValue();
		this->dark_bullet_2 = map["dark_bullet_2"sv];
		this->_tex_dark_bullet_2 = this->dark_bullet_2->tex;
		this->_texid_dark_bullet_2 = this->_tex_dark_bullet_2->GetValue();
		this->dark_bullet_3 = map["dark_bullet_3"sv];
		this->_tex_dark_bullet_3 = this->dark_bullet_3->tex;
		this->_texid_dark_bullet_3 = this->_tex_dark_bullet_3->GetValue();
		this->dark_bullet_4 = map["dark_bullet_4"sv];
		this->_tex_dark_bullet_4 = this->dark_bullet_4->tex;
		this->_texid_dark_bullet_4 = this->_tex_dark_bullet_4->GetValue();
		this->dark_bullet_5 = map["dark_bullet_5"sv];
		this->_tex_dark_bullet_5 = this->dark_bullet_5->tex;
		this->_texid_dark_bullet_5 = this->_tex_dark_bullet_5->GetValue();
		this->dark_bullet_6 = map["dark_bullet_6"sv];
		this->_tex_dark_bullet_6 = this->dark_bullet_6->tex;
		this->_texid_dark_bullet_6 = this->_tex_dark_bullet_6->GetValue();
		...
		this->fire_bullet_0 = map["fire_bullet_0"sv];
		this->_tex_fire_bullet_0 = this->fire_bullet_0->tex;
		this->_texid_fire_bullet_0 = this->_tex_fire_bullet_0->GetValue();
		this->fire_bullet_1 = map["fire_bullet_1"sv];
		this->_tex_fire_bullet_1 = this->fire_bullet_1->tex;
		this->_texid_fire_bullet_1 = this->_tex_fire_bullet_1->GetValue();
		this->fire_bullet_2 = map["fire_bullet_2"sv];
		this->_tex_fire_bullet_2 = this->fire_bullet_2->tex;
		this->_texid_fire_bullet_2 = this->_tex_fire_bullet_2->GetValue();
		this->fire_bullet_3 = map["fire_bullet_3"sv];
		this->_tex_fire_bullet_3 = this->fire_bullet_3->tex;
		this->_texid_fire_bullet_3 = this->_tex_fire_bullet_3->GetValue();
		this->fire_bullet_4 = map["fire_bullet_4"sv];
		this->_tex_fire_bullet_4 = this->fire_bullet_4->tex;
		this->_texid_fire_bullet_4 = this->_tex_fire_bullet_4->GetValue();
		this->fire_bullet_5 = map["fire_bullet_5"sv];
		this->_tex_fire_bullet_5 = this->fire_bullet_5->tex;
		this->_texid_fire_bullet_5 = this->_tex_fire_bullet_5->GetValue();
		this->fire_bullet_6 = map["fire_bullet_6"sv];
		this->_tex_fire_bullet_6 = this->fire_bullet_6->tex;
		this->_texid_fire_bullet_6 = this->_tex_fire_bullet_6->GetValue();
		this->fire_explosion_0 = map["fire_explosion_0"sv];
		this->_tex_fire_explosion_0 = this->fire_explosion_0->tex;
		this->_texid_fire_explosion_0 = this->_tex_fire_explosion_0->GetValue();
		this->fire_explosion_1 = map["fire_explosion_1"sv];
		this->_tex_fire_explosion_1 = this->fire_explosion_1->tex;
		this->_texid_fire_explosion_1 = this->_tex_fire_explosion_1->GetValue();
		this->fire_explosion_2 = map["fire_explosion_2"sv];
		this->_tex_fire_explosion_2 = this->fire_explosion_2->tex;
		this->_texid_fire_explosion_2 = this->_tex_fire_explosion_2->GetValue();
		this->fire_explosion_3 = map["fire_explosion_3"sv];
		this->_tex_fire_explosion_3 = this->fire_explosion_3->tex;
		this->_texid_fire_explosion_3 = this->_tex_fire_explosion_3->GetValue();
		this->fire_explosion_4 = map["fire_explosion_4"sv];
		this->_tex_fire_explosion_4 = this->fire_explosion_4->tex;
		this->_texid_fire_explosion_4 = this->_tex_fire_explosion_4->GetValue();
		...
		this->global_explosion_0 = map["global_explosion_0"sv];
		this->_tex_global_explosion_0 = this->global_explosion_0->tex;
		this->_texid_global_explosion_0 = this->_tex_global_explosion_0->GetValue();
		this->global_explosion_1 = map["global_explosion_1"sv];
		this->_tex_global_explosion_1 = this->global_explosion_1->tex;
		this->_texid_global_explosion_1 = this->_tex_global_explosion_1->GetValue();
		this->global_explosion_2 = map["global_explosion_2"sv];
		this->_tex_global_explosion_2 = this->global_explosion_2->tex;
		this->_texid_global_explosion_2 = this->_tex_global_explosion_2->GetValue();
		this->global_explosion_3 = map["global_explosion_3"sv];
		this->_tex_global_explosion_3 = this->global_explosion_3->tex;
		this->_texid_global_explosion_3 = this->_tex_global_explosion_3->GetValue();
		this->global_explosion_4 = map["global_explosion_4"sv];
		this->_tex_global_explosion_4 = this->global_explosion_4->tex;
		this->_texid_global_explosion_4 = this->_tex_global_explosion_4->GetValue();
		this->global_explosion_5 = map["global_explosion_5"sv];
		this->_tex_global_explosion_5 = this->global_explosion_5->tex;
		this->_texid_global_explosion_5 = this->_tex_global_explosion_5->GetValue();
		this->global_explosion_6 = map["global_explosion_6"sv];
		this->_tex_global_explosion_6 = this->global_explosion_6->tex;
		this->_texid_global_explosion_6 = this->_tex_global_explosion_6->GetValue();
		this->global_explosion_7 = map["global_explosion_7"sv];
		this->_tex_global_explosion_7 = this->global_explosion_7->tex;
		this->_texid_global_explosion_7 = this->_tex_global_explosion_7->GetValue();
		this->global_explosion_8 = map["global_explosion_8"sv];
		this->_tex_global_explosion_8 = this->global_explosion_8->tex;
		this->_texid_global_explosion_8 = this->_tex_global_explosion_8->GetValue();
		this->laser1 = map["laser1"sv];
		this->_tex_laser1 = this->laser1->tex;
		this->_texid_laser1 = this->_tex_laser1->GetValue();
		...
		this->ui_flags_0 = map["ui_flags_0"sv];
		this->_tex_ui_flags_0 = this->ui_flags_0->tex;
		this->_texid_ui_flags_0 = this->_tex_ui_flags_0->GetValue();
		this->ui_flags_1 = map["ui_flags_1"sv];
		this->_tex_ui_flags_1 = this->ui_flags_1->tex;
		this->_texid_ui_flags_1 = this->_tex_ui_flags_1->GetValue();
		...
		this->weapon_1 = map["weapon_1"sv];
		this->_tex_weapon_1 = this->weapon_1->tex;
		this->_texid_weapon_1 = this->_tex_weapon_1->GetValue();
	...
	dark_bullet_.Add(dark_bullet_3);
	dark_bullet_.Add(dark_bullet_4);
	dark_bullet_.Add(dark_bullet_5);
	dark_bullet_.Add(dark_bullet_6);
	ef_.Add(ef_1);
	fire_bullet_.Add(fire_bullet_0);
	fire_bullet_.Add(fire_bullet_1);
	fire_bullet_.Add(fire_bullet_2);
	fire_bullet_.Add(fire_bullet_3);
	fire_bullet_.Add(fire_bullet_4);
	fire_bullet_.Add(fire_bullet_5);
	fire_bullet_.Add(fire_bullet_6);
	fire_explosion_.Add(fire_explosion_0);
	fire_explosion_.Add(fire_explosion_1);
	fire_explosion_.Add(fire_explosion_2);
	fire_explosion_.Add(fire_explosion_3);
	fire_explosion_.Add(fire_explosion_4);
	fire_explosion_.Add(fire_explosion_5);
	...
	global_explosion_.Add(global_explosion_0);
	global_explosion_.Add(global_explosion_1);
	global_explosion_.Add(global_explosion_2);
	global_explosion_.Add(global_explosion_3);
	global_explosion_.Add(global_explosion_4);
	global_explosion_.Add(global_explosion_5);
